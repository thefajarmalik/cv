...
\begin{document}
    ...
    \section{Education}
        ...
        2023 – 2024
            ...
            \begin{highlights}
                ...
                \item \textbf{Coursework:} Wireless Network Security, Critical Infrastructure Security.
            \end{highlights}
        \end{threecolentry}
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \begin{highlights}
                \item Developed an Android app serving as a tracking dashboard. The project won a prestigious national research competition, showcasing innovation and technical excellence.
        ...
        \begin{twocolentry}{
            ...
            \textbf{AHPSAW (bachelor thesis project) \href{https://github.com/thefajarmalik/AHPSAW}{GitHub}}
            \begin{highlights}
                ...
                \item \textbf{Technologies:} Unsupervised Machine Learning, Android Studio, Kotlin, Firebase, Weather API.
            \end{highlights}
        \end{twocolentry}
